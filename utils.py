...
class EuclideanDistTracker:
    ...
    def update(self, objects_rect):
        try:
            ...
            print("Une erreur est survenue dans la fonction update :", e)
            return []
...
def get_color_name(hsv_value):
    try:
        ...
        print("Une erreur est survenue dans la fonction get_color_name :", e)
        return "Inconnu"
...
def get_color(vehicle_region, v1_min, v2_min, v3_min, v1_max, v2_max, v3_max):
    try:
        ...
        print("Une erreur est survenue dans la fonction get_color :", e)
        return None
...
def dist_calculator(box_width, img_w):
    try:
        ...
        print("Une erreur est survenue dans la fonction dist_calculator :", e)
        return None
...
def find_closest_vehicle(detected_vehicles, img_width):
    try:
        ...
        print("Une erreur est survenue dans la fonction find_closest_vehicle :", e)
        return None
...
def postProcess(outputs, img, colors, classNames, confThreshold, nmsThreshold, required_class_index, tracker):
    try:
        ...
        print("Une erreur est survenue dans la fonction postProcess :", e)
        return None
